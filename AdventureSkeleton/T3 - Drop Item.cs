...
//            else if (items[indexOfItem].Location != Inventory)
//            {
//                Console.WriteLine("You haven't got that item!");
//            }
//            else if (items[indexOfItem].Location >= MinimumIDForItem && items[GetIndexOfItem("", items[indexOfItem].Location, items)].Location != Inventory)
//            {
//                Console.WriteLine("You can't find " + itemToDrop + ".");
//            }
//            else if (items[indexOfItem].Location < MinimumIDForItem && items[indexOfItem].Location != Inventory)
//            {
//                Console.WriteLine("You can't find " + itemToDrop + ".");
//            }
//            else
...
//                    Console.WriteLine("You have dropped that now.");
//                }
//            }
//        }
