...
//        private static List<Item> getItemsInLocation(List<Item> items, int location)
//        {
...
//        private static void PrintItemsInLocation(List<Item> items, String locationName, int location)
//        {
//            List<Item> locationItems = getItemsInLocation(items, location);
//            if (locationItems.Count <= 0) return;

//            Console.WriteLine("Items In " + locationName + ": ");
//            for (int i = 0; i < locationItems.Count; i++)
//            {
//                Console.Write(locationItems[i].Name);
//                if (i < locationItems.Count - 1)
//                {
//                    Console.Write(", ");
//                }

//                Console.WriteLine();
//                PrintItemsInLocation(items, locationItems[i].Name, locationItems[i].ID);
//            }
//            Console.WriteLine();
//        }
...
//                    if (items[indexOfItem].Name == "torch")
//                    {
//                        Item torch = items[indexOfItem];
//                        Place cellar = places.Find(p => p.Description.Contains("cellar"));
//                        if (currentLocation != cellar.id) return;

//                        PrintItemsInLocation(items, "Cellar", cellar.id);
//                    }
//                    return;
//                }
//            }
