...
//            {
//                string result = "desc: " + Description + ", ";
//                result += "id: " + id + ", ";
//                result += "north: " + North + ", ";
//                result += "south: " + South + ", ";
//                result += "west: " + West + ", ";
...
//                    Console.WriteLine("CurrentLocation: " + characters[0].CurrentLocation);
...
//        static void addSecretCorridoor(List<Place> places)
//        {
//            Place longCorridoor = places.Find(
//                delegate(Place p)
//                {
//                    return p.id == 4;
//                }
//            );
//            longCorridoor.South = 9;

//            Place place = new Place();
//            place.id = 9;
//            place.Description = "You are in the secret corridoor. This corridoor is top secret - super confidential.";
//            place.North = 4;
//            places.Add(place);
//        }
...
//            {
//                addSecretCorridoor(places);
//                for (int i = 0; i < places.Count; i++)
//                {
//                    Console.WriteLine("place " + i + ": " + places[i].toString());
//                }
