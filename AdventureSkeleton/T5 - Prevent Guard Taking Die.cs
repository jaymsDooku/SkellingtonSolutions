...
//        private static List<Item> getAllDieFrom(List<Item> items)
//        {
//            List<Item> die = new List<Item>();
//            for (int i = 0; i < items.Count; i++)
//            {
//                if (items[i].Name.Contains("die"))
//                {
//                    die.Add(items[i]);
//                }
//            }
...
//        {
//            List<Item> inventory = getInventoryItems(items);
//            List<Item> die = getAllDieFrom(inventory);

//            if (inventory.Count == die.Count)
//            {
//                Console.WriteLine("You only have a die left. No items taken.");
//                return;
//            }
...
//            while (count < items.Count)
//            {
//                if (items[count].Location == Inventory && !items[count].Name.Contains("die"))
//                {
//                    listOfIndicesOfItemsInInventory.Add(count);
//                }
//                count++;
