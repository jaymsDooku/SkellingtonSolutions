...
//        private static int getInventorySize(List<Item> items)
//        {
//            int size = 0;
...
//                {
//                    Console.WriteLine("In Inventory: " + items[i].Name);
//                    size++;
//                }
//            }
//            return size;
...
//                {
//                    int inventorySize = getInventorySize(items);
//                    Console.WriteLine("Inventory Size: " + inventorySize);
//                    if (inventorySize > INVENTORY_SIZE)
//                    {
//                        Console.WriteLine("You can't pick up another item; reached inventory limit.");
//                        return;
//                    }
