...
//        private static Place getPlaceFromId(List<Place> places, int id)
//        {
//            return places.Find(
//                    delegate(Place place)
//                    {
//                        return place.id == id;
//                    }
//                );
...
//        private static int getRandomWithExclusion(int maxRange, int exclude)
//        {
//            int result = -1;

//            do
//            {
//                result = random.Next(maxRange);
//            }while (result == -1 || result == exclude);

//            return result;
//        }

//        private static void teleport(Character you, List<Place> places)
//        {
//            List<int> placeIds = new List<int>();
//            for (int i = 0; i < places.Count; i++)
//            {
//                placeIds.Add(places[i].id);
//            }

//            int placeIdIndex = getRandomWithExclusion(placeIds.Count, you.CurrentLocation-1);
//            int placeId = placeIds[placeIdIndex];

//            Console.WriteLine("You have teleported from place " + you.CurrentLocation + " to place " + placeId);
//            you.CurrentLocation = placeId;
//        }
