...
//        //Extracts the command from the text. i.e. 'examine rug' becomes just 'examine'
//        //Doesn't remove whitespace prepended to text or appended to text. Doesn't care about whitespace inbetween words though.
...
//                return instruction;
//            }
//            //Console.WriteLine("Command Before: " + command);
//            while (instruction.Length > 0 && instruction[0] != ' ')
//            {
//                command += instruction[0];
//                instruction = instruction.Remove(0, 1);
//            }
//            //Console.WriteLine("Command After 1st Loop: " + command);
//            while (instruction.Length > 0 && instruction[0] == ' ')
//            {
//                instruction = instruction.Remove(0, 1);
//            }
//            //Console.WriteLine("Command After 2nd Loop: " + command);
//            return command;
//        }
...
//        private static void Examine(List<Item> items, List<Character> characters, List<Place> places, string itemToExamine, int currentLocation)
//        {
//            int Count = 0;
...
//            {
//                displayDetailsOfLocation(items, places, currentLocation);
//            }
//            else
//            {
...
//        {
//            String[] allCmds = { "get", "use", "go", "read", "examine", "open", "close", "move", "say", "playdice", "quit" };
//            for (int i = 0; i < allCmds.Length; i++)
//            {
//                Console.WriteLine(allCmds[i]);
//            }
//        }

//        private static void displayDetailsOfLocation(List<Item> items, List<Place> places, int location)
//        {
//            Console.WriteLine(places[location - 1].Description);
//            DisplayGettableItemsInLocation(items, location);
//        }
...
//                    Console.WriteLine();
//                    Console.WriteLine();
//                    displayDetailsOfLocation(items, places, characters[0].CurrentLocation);
//                    moved = false;
//                }
...
//            if (LoadGame(filename, characters, items, places)) //If you type in an invalid file name, it won't prompt again, it just finishes the program.
//            {
...
//                    if (item.Name == "gold key")
//                    {
//                        Console.WriteLine("GOLD KEY: " + item.ToString());
//                    }
//                    if (item.Name == "flag")
//                    {
...
//                    Console.WriteLine("place: " + place.ToString());
//                }
